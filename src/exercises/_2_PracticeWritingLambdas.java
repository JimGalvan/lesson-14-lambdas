...
class _2_PracticeWritingLambdas {
	...
	Function<String, String> REMOVE_VOWELS_LAMBDA = String -> String.replaceAll("[AaEeIiOoUu]", "");
	...
	Function<Character, Integer> ASCII_LAMBDA = x -> {
		return (int) x;
	};

	Function<String, String> CAPITALIZE_LAMBDA = word -> {
		return word.substring(0, 1).toUpperCase() + word.substring(1);
	};

	Function<String, String> BLACKOUT_LAMBDA = word -> {
